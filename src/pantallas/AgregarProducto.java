...
public class AgregarProducto extends javax.swing.JFrame {
    ...
    private CátalogoProductos padre;
    ...
    public AgregarProducto() {
       ...
       public AgregarProducto(CátalogoProductos padre) {
        initComponents();
        this.padre = padre;
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Registra tu Producto Miguelito!!!");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "¿Deseas guardar?")
            ...
            producto.setPrecio((int) Double.parseDouble(txtPrecio.getText()));
